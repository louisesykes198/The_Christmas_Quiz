...
// Function to show a question, index will match the position of the current button.
...
// Function to check the answer, index checks if the button clicked is the correct answer for the question.
...
// Event listeners to the answer buttons, index is used to link each button to its corresponding answer
answerButtons.forEach((button, index) => {
